...
func main() {
	...
	log.Print("server starting at localhost:8081 ... ")
...
func LoginHandler(w http.ResponseWriter, r *http.Request) {
	...
	q.Add("scope", "openid profile email broker")
	...
	// log.Printf("Broker 302 %+v", redirectPath)
...
func AuthCodeCallbackHandler(w http.ResponseWriter, r *http.Request) {
	...
	session, err := sessionStore.Get(r, "okta-hosted-login-session-store-broker")
	if err != nil {
